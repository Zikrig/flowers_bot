...
class OrderStates(StatesGroup):
    ...
    waiting_receipt = State()  # Ожидание ответа «Это чек? Да/Нет» после отправки файла
...
async def order_confirmed(callback: CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        payment_text = (
            ...
            "После оплаты отправьте в этот чат фото или любой файл с квитанцией — мы примем его как чек и подтвердим оплату."
        )
